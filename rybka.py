...
def software_config_params():
    ...
    log.INFO_BOLD(f"TRADE_SYMBOL    set to: {TRADE_SYMBOL:>50}")
    log.INFO_BOLD(f"TRADE_QUANTITY  set to: {TRADE_QUANTITY:>50} coins per transaction")
    log.INFO_BOLD(f"MIN_PROFIT      set to: {MIN_PROFIT:>50} $ per transaction")
    log.INFO_BOLD(f"RSI_PERIOD      set to: {RSI_PERIOD:>50} minutes")
    log.INFO_BOLD(f"RSI_FOR_BUY     set to: {RSI_FOR_BUY:>50} threshold")
    log.INFO_BOLD(f"RSI_FOR_SELL    set to: {RSI_FOR_SELL:>50} threshold")
    log.INFO(" ")
