...
C = Button(
    top,
    text="LIVE",
    command=lambda input="restarter_live": software_start(input),
    cursor="hand1",
    style="BW.TLabel",
)
D = Button(
    top,
    text="DEMO",
    command=lambda input="restarter_demo": software_start(input),
    cursor="hand1",
    style="BW.TLabel",
)
...
heading_restarter = Label(
    text="Launch RESTARTER:",
    background="black",
    foreground="DarkGoldenrod4",
    style="Heading.TLabel",
)
